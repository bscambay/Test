		...
		<!-- BEGIN BLANK PAGE PORTLET-->
       	<div class="widget yellow">
           	<div class="widget-title">
               	...
               	<span class="tools">
					<a data-ng-click="cancelEditPackage()" class="icon-remove" title="Cancel"></a>
				</span>
				...
				<div class="row-fluid">
					<div class="span-12">
						...
						<form role="form" class="form-horizontal">
							...
							<c:if test="${ readOnly }">
								<button class="btn btn-default mtop10" data-ng-click="cancelEditPackage()">
							...
							<c:if test="${ !readOnly }">
								...
								<button class="btn btn-danger mtop10" data-ng-click="cancelEditPackage()">
