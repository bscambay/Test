						...
						<c:forEach items="${packages}" var="_package">
							<tr>
								...
								<td style="text-align:center">
									<a class="btn btn-default" href="#packages/view/${_package.id}" title="View Package">
										<span class="icon-eye-open"></span> View
									</a>
									<a class="btn btn-primary" href="#packages/copy/${_package.id}" title="Copy Package">
										<span class="icon-copy"></span> Copy
									</a>
									<a class="btn btn-primary" href="#packages/edit/${_package.id}" title="Edit Package">
										<span class="icon-edit"></span> Edit
									</a>
									<button class="btn btn-danger" data-ng-click="deletePackage(${_package.id})" title="Delete Package">
